...
<div class="form-box">
    <div class="form-top">
        ...
        <div class="form-bottom">
            <form role="form" action="/UpDoctor.do" method="post" class="login-form">
                ...
                <div class="form-group col-xs-12">
                    <label class="sr-only" for="userEmail"></label>介绍(*):<input
                        style="font-weight: bold" type="text" name="account"
                        class="form-control input-control clearfix"
                        /><span id="accountTip"></span>
                </div>
                <div class="form-group col-xs-12">
                    <label class="sr-only" for="userEmail"></label>电话(*):<input
