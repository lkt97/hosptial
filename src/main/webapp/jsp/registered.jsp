        ...
        <form class="form-login" action="LoginAndRegisterServlet?op=register" method="post">
            ...
            <div class="register-box">
                <label for="password" class="other_label">设 置 密 码
                    <input id="password"  name="password" id="password" maxlength="20" type="password" placeholder="建议至少使用两种字符组合" onkeyup="value=value.replace(/\s/g,'')"/>
                </label>
                <div class="tips" >
            ...
            <div class="register-box">
                <label for="repassword" class="other_label">确 认 密 码
                    <input maxlength="20"  name="repassword" id="repassword" type="password" placeholder="请再次输入密码" onkeyup="value=value.replace(/\s/g,'')"/>
                </label>
                <div class="tips" >
            ...
            <div class="register-box">
                <label for="mobile" class="other_label">手 机 号 码
                    <input type="text" name="mobile" id="mobile" placeholder="建议输入常用的手机号码" onkeyup="this.value=this.value.replace(/\D/g,'')" onafterpaste="this.value=this.value.replace(/\D/g,'')" >
                </label>
            ...
            <div class="register-box">
                <label for="xcode" class="other_label">验 证 码
                    <input maxlength="20" type="text" id="xcode" placeholder="请输入验证码"/>
                </label>
                <span id="code"></span>
                <div class="tips" >
